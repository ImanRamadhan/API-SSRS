namespace _Ext {
    export namespace AuditLogService {
        ...
        export declare function List(request: AuditLogSpListRequest, onSuccess?: (response: Serenity.ListResponse<AuditLogRow>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
