    ...
    public static partial class Texts
    {
        ...
        public static partial class Controls
        {
            public static class QuickSearch
            {
                ...
                public static LocalText Hint = "Enter the Shortcut Text to Search for...";
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your SCMONLINE Password";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your SCMONLINE Account";
                    ...
                    public static LocalText FormTitle = "Sign up for SCMONLINE";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "SCMONLINE";
        }
