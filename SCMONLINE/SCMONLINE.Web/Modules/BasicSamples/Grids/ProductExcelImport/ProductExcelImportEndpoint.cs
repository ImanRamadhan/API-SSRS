...
namespace SCMONLINE.BasicSamples.Endpoints
{
    ...
    {
        [HttpPost]
        public ExcelImportResponse<object> ExcelImport(IUnitOfWork uow, ExcelImportRequest request)
        {
            ...
            var response = new ExcelImportResponse<object>();
