namespace SCMONLINE.Procurement.Entities
{
    ...
    [ConnectionKey("Default"), TableName("[dbo].[CommitteeMember]")]
    [DisplayName("F19 Committee Member"), InstanceName("F19 Committee Member"), TwoLevelCached]
    [ReadPermission("Procurement:F19_CommitteeMember:Read")]
    [InsertPermission("Procurement:F19_CommitteeMember:Insert")]
    [UpdatePermission("Procurement:F19_CommitteeMember:Update")]
    [DeletePermission("Procurement:F19_CommitteeMember:Delete")]
    public sealed class F19_CommitteeMemberRow : Row, IIdRow, INameRow
    {

        [DisplayName("Committee Member Id"), Identity]
        public Int32? CommitteeMemberId { get { return Fields.CommitteeMemberId[this]; } set { Fields.CommitteeMemberId[this] = value; } }
		public partial class RowFields { public Int32Field CommitteeMemberId; }
        ...
        public Boolean? ApprovalStatus { get { return Fields.ApprovalStatus[this]; } set { Fields.ApprovalStatus[this] = value; } }
		public partial class RowFields { public BooleanField ApprovalStatus; }

        [DisplayName("Approval Date")]
        public DateTime? ApprovalDate { get { return Fields.ApprovalDate[this]; } set { Fields.ApprovalDate[this] = value; } }
		public partial class RowFields { public DateTimeField ApprovalDate; }

        [DisplayName("Approval By"), Size(150), QuickSearch]
        public String ApprovalBy { get { return Fields.ApprovalBy[this]; } set { Fields.ApprovalBy[this] = value; } }
		public partial class RowFields { public StringField ApprovalBy; }
        ...
        IIdField IIdRow.IdField { get { return Fields.CommitteeMemberId; } }

        StringField INameRow.NameField { get { return Fields.ApprovalBy; } }

        public static readonly RowFields Fields = new RowFields().Init();

        public F19_CommitteeMemberRow() : base(Fields) { }
