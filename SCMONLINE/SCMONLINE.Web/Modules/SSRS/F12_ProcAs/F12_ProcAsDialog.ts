...
namespace SCMONLINE.Procurement {
    ...
    export class F12_ProcAsDialog extends _Ext.DialogBase<ProcurementRow, any> {
        protected getFormKey() { return F12_ProcAsForm.formKey; }
        ...
        protected form = new F12_ProcAsForm(this.idPrefix);
        getToolbarButtons() {
