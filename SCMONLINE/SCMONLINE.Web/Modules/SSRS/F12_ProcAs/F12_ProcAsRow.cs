namespace SCMONLINE.Procurement.Entities
{
    ...
    [DisplayName("F12 Proc As"), InstanceName("F12 Proc As"), TwoLevelCached]
    [ReadPermission("Procurement:F12_ProcAs:Read")]
    [InsertPermission("Procurement:F12_ProcAs:Insert")]
    [UpdatePermission("Procurement:F12_ProcAs:Update")]
    [DeletePermission("Procurement:F12_ProcAs:Delete")]
    public sealed class F12_ProcAsRow : Row, IIdRow, INameRow
    {
        ...
        public F12_ProcAsRow() : base(Fields) { }
