namespace SCMONLINE.Procurement.Entities
{
    ...
    [DisplayName("F4 Aanwijzing"), InstanceName("F4 Aanwijzing"), TwoLevelCached]
    [ReadPermission("Procurement:F4_Aanwijzing:Read")]
    [InsertPermission("Procurement:F4_Aanwijzing:Insert")]
    [UpdatePermission("Procurement:F4_Aanwijzing:Update")]
    [DeletePermission("Procurement:F4_Aanwijzing:Delete")]
    public sealed class F4_AanwijzingRow : Row, IIdRow, INameRow
    {
        ...
        public F4_AanwijzingRow() : base(Fields) { }
