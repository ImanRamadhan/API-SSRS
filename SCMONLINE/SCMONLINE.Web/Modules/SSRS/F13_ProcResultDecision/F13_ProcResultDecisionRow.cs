namespace SCMONLINE.Procurement.Entities
{
    ...
    [DisplayName("F13 Proc Result Decision"), InstanceName("F13 Proc Result Decision"), TwoLevelCached]
    [ReadPermission("Procurement:F13_ProcResultDecision:Read")]
    [InsertPermission("Procurement:F13_ProcResultDecision:Insert")]
    [UpdatePermission("Procurement:F13_ProcResultDecision:Update")]
    [DeletePermission("Procurement:F13_ProcResultDecision:Delete")]
    public sealed class F13_ProcResultDecisionRow : Row, IIdRow, INameRow
    {
        ...
        public F13_ProcResultDecisionRow() : base(Fields) { }
