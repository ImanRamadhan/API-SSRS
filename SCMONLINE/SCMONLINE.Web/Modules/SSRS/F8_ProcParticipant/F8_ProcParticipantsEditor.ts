...
namespace SCMONLINE.Procurement {
    ...
    export class F8_ProcParticipantsEditor extends Common.GridEditorBase<ProcParticipantRow> {
        protected getColumnsKey() { return "Procurement.F8_ProcParticipant"; }
        protected getDialogType() { return F8_ProcParticipantDialog; }
        ...
        protected initEntityDialog(itemType: string, dialog: Serenity.Widget<any>) {
            ...
            (dialog as F8_ProcParticipantDialog).parentDialog = this.parentDialog;
        }
