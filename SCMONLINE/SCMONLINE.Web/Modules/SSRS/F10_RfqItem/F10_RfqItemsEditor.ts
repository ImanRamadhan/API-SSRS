...
namespace SCMONLINE.Procurement {
    ...
    export class F10_RfqItemsEditor extends Common.GridEditorBase<RfqItemRow> {
        ...
        protected getButtons(): Serenity.ToolButton[] {
            ...
            buttons.push({
                ...
                onClick: () => {
                    ...
                    Q.postToService({ service: F10_RfqItemService.baseUrl + "/ListExcelOwnerEstimateReview", request: gridRows, target: '_blank' });
                }
            });
