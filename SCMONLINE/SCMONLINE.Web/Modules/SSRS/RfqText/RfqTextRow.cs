namespace SCMONLINE.Procurement.Entities
{
    ...
    [ConnectionKey("Default"), TableName("[dbo].[RFQText]")]
    [DisplayName("Rfq Text"), InstanceName("Rfq Text"), TwoLevelCached]
    [ReadPermission("Procurement:RfqText:Read")]
    [InsertPermission("Procurement:RfqText:Insert")]
    [UpdatePermission("Procurement:RfqText:Update")]
    [DeletePermission("Procurement:RfqText:Delete")]
    [LookupScript]
    public sealed class RfqTextRow : Row, IIdRow, INameRow
    {

        [DisplayName("Rfq Text Id"), Column("RFQTextId"), Identity]
        [EditLink, QuickSearch]
        public Int32? RfqTextId { get { return Fields.RfqTextId[this]; } set { Fields.RfqTextId[this] = value; } }
        public partial class RowFields { public Int32Field RfqTextId; }
        ...
        [DisplayName("Text"), Size(4), ForeignKey("[dbo].[PurchDocTextRef]", "TextId"), LeftJoin("jText"), TextualField("TextMeaning")]
        [LookupEditor(typeof(PurchDocTextRefRow))]
        [EditLink, QuickSearch]
        ...
        [DisplayName("Text Meaning"), Expression("jText.[Meaning]"), ReadOnly(true)]
        [MinSelectLevel(SelectLevel.List)]
        [EditLink, QuickSearch]
        public String TextMeaning { get { return Fields.TextMeaning[this]; } set { Fields.TextMeaning[this] = value; } }
        public partial class RowFields { public StringField TextMeaning; }


        #endregion Foreign Fields


        IIdField IIdRow.IdField { get { return Fields.RfqTextId; } }

        StringField INameRow.NameField { get { return Fields.TextLine; } }

        public static readonly RowFields Fields = new RowFields().Init();

        public RfqTextRow() : base(Fields) { }
