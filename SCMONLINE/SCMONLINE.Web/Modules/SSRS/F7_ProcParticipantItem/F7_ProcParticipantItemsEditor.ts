...
namespace SCMONLINE.Procurement {
    ...
    export class F7_ProcParticipantItemsEditor extends Common.GridEditorBase<ProcParticipantItemRow> {
        ...
        protected getButtons(): Serenity.ToolButton[] {
            ...
            buttons.push({
                ...
                onClick: () => {
                    ...
                    Q.postToService({ service: F7_ProcParticipantItemService.baseUrl + "/ListExcelBidPrice", request: gridRows, target: '_blank' });
                }
            });
