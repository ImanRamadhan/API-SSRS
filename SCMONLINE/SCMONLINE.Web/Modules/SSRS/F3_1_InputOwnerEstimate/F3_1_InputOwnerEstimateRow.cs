namespace SCMONLINE.Procurement.Entities
{
    ...
    [DisplayName("F3 1 Input Owner Estimate"), InstanceName("F3 1 Input Owner Estimate"), TwoLevelCached]
    [ReadPermission("Procurement:F3_1_InputOwnerEstimate:Read")]
    [InsertPermission("Procurement:F3_1_InputOwnerEstimate:Insert")]
    [UpdatePermission("Procurement:F3_1_InputOwnerEstimate:Update")]
    [DeletePermission("Procurement:F3_1_InputOwnerEstimate:Delete")]
    public sealed class F3_1_InputOwnerEstimateRow : Row, IIdRow, INameRow
    {
        ...
        public F3_1_InputOwnerEstimateRow() : base(Fields) { }
