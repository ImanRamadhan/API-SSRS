namespace SCMONLINE.Procurement.Entities
{
    ...
    [DisplayName("F9 Proc Participant Item"), InstanceName("F9 Proc Participant Item"), TwoLevelCached]
    [ReadPermission("Procurement:F9_ProcParticipantItem:Read")]
    [InsertPermission("Procurement:F9_ProcParticipantItem:Insert")]
    [UpdatePermission("Procurement:F9_ProcParticipantItem:Update")]
    [DeletePermission("Procurement:F9_ProcParticipantItem:Delete")]
    public sealed class F9_ProcParticipantItemRow : Row, IIdRow, INameRow
    {
        ...
        public F9_ProcParticipantItemRow() : base(Fields) { }
