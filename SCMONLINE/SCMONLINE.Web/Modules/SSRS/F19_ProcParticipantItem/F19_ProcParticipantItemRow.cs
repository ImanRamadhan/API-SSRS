namespace SCMONLINE.Procurement.Entities
{
    ...
    [DisplayName("F19 Proc Participant Item"), InstanceName("F19 Proc Participant Item"), TwoLevelCached]
    [ReadPermission("Procurement:F19_ProcParticipantItem:Read")]
    [InsertPermission("Procurement:F19_ProcParticipantItem:Insert")]
    [UpdatePermission("Procurement:F19_ProcParticipantItem:Update")]
    [DeletePermission("Procurement:F19_ProcParticipantItem:Delete")]
    public sealed class F19_ProcParticipantItemRow : Row, IIdRow, INameRow
    {
        ...
        public F19_ProcParticipantItemRow() : base(Fields) { }
