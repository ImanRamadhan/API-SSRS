...
namespace SCMONLINE.Procurement {
    ...
    export class F19_ProcParticipantItemsEditor extends Common.GridEditorBase<ProcParticipantItemRow> {
        ...
        protected getButtons(): Serenity.ToolButton[] {
            ...
            buttons.push({
                ...
                onClick: () => {
                    ...
                    Q.postToService({ service: F19_ProcParticipantItemService.baseUrl + "/ListExcelBidPrice", request: gridRows, target: '_blank' });
                }
            });
