...
namespace SCMONLINE.Procurement {
    ...
    export class F10_ProcParticipantItemsEditor extends Common.GridEditorBase<ProcParticipantItemRow> {
        ...
        protected initEntityDialog(itemType: string, dialog: Serenity.Widget<any>) {
            ...
            (dialog as F10_ProcParticipantItemDialog).parentDialog = this.parentDialog;
        }
