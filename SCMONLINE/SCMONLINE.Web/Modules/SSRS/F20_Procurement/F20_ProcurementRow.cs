namespace SCMONLINE.Procurement.Entities
{
    ...
    [DisplayName("F20 Procurement"), InstanceName("F20 Procurement"), TwoLevelCached]
    [ReadPermission("Procurement:F20_Procurement:Read")]
    [InsertPermission("Procurement:F20_Procurement:Insert")]
    [UpdatePermission("Procurement:F20_Procurement:Update")]
    [DeletePermission("Procurement:F20_Procurement:Delete")]
    public sealed class F20_ProcurementRow : Row, IIdRow, INameRow
    {
        ...
        public F20_ProcurementRow() : base(Fields) { }
