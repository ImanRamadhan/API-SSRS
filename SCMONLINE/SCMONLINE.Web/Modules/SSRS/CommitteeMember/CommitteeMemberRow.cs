namespace SCMONLINE.Procurement.Entities
{
    ...
    [DisplayName("Committee Member"), InstanceName("Committee Member"), TwoLevelCached]
    [ReadPermission("Procurement:CommitteeMember:Read")]
    [InsertPermission("Procurement:CommitteeMember:Insert")]
    [UpdatePermission("Procurement:CommitteeMember:Update")]
    [DeletePermission("Procurement:CommitteeMember:Delete")]
    public sealed class CommitteeMemberRow : Row, IIdRow, INameRow
    {
        ...
        [LookupEditor(typeof(CommitteeRoleRow))]
        [EditLink, QuickSearch]
        ...
        [ReadOnly(true)]
        [EditLink, QuickSearch]
        public ApproveTidakApprove? ApprovalStatus { get { return (ApproveTidakApprove?)Fields.ApprovalStatus[this]; } set { Fields.ApprovalStatus[this] = (Int32?)value; } }
        ...
        [DisplayName("PDSI Role"), Expression("jRole.[RoleName]"), ReadOnly(true)]
        ...
        [DisplayName("Committee Role"), Expression("jCommitteeRole.[Name]"), ReadOnly(true)]
        [MinSelectLevel(SelectLevel.List)]
        [LookupInclude]
        [EditLink, QuickSearch]
        ...
        StringField INameRow.NameField { get { return Fields.CommitteeRoleName; } }

        public static readonly RowFields Fields = new RowFields().Init();

        public CommitteeMemberRow() : base(Fields) { }
