namespace SCMONLINE.Procurement.Entities
{
    ...
    [DisplayName("F15 Objection Process"), InstanceName("F15 Objection Process"), TwoLevelCached]
    [ReadPermission("Procurement:F15_ObjectionProcess:Read")]
    [InsertPermission("Procurement:F15_ObjectionProcess:Insert")]
    [UpdatePermission("Procurement:F15_ObjectionProcess:Update")]
    [DeletePermission("Procurement:F15_ObjectionProcess:Delete")]
    public sealed class F15_ObjectionProcessRow : Row, IIdRow, INameRow
    {
        ...
        public F15_ObjectionProcessRow() : base(Fields) { }
