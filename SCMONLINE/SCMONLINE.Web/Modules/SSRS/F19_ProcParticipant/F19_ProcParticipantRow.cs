namespace SCMONLINE.Procurement.Entities
{
    ...
    [DisplayName("F19 Proc Participant"), InstanceName("F19 Proc Participant"), TwoLevelCached]
    [ReadPermission("Procurement:F19_ProcParticipant:Read")]
    [InsertPermission("Procurement:F19_ProcParticipant:Insert")]
    [UpdatePermission("Procurement:F19_ProcParticipant:Update")]
    [DeletePermission("Procurement:F19_ProcParticipant:Delete")]
    public sealed class F19_ProcParticipantRow : Row, IIdRow, INameRow
    {
        ...
        public F19_ProcParticipantRow() : base(Fields) { }
