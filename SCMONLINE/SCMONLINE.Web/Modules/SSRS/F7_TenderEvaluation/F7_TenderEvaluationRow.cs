namespace SCMONLINE.Procurement.Entities
{
    ...
    [DisplayName("F7 Open Tender Document"), InstanceName("F7 Open Tender Document"), TwoLevelCached]
    [ReadPermission("Procurement:F7_TenderEvaluation:Read")]
    [InsertPermission("Procurement:F7_TenderEvaluation:Insert")]
    [UpdatePermission("Procurement:F7_TenderEvaluation:Update")]
    [DeletePermission("Procurement:F7_TenderEvaluation:Delete")]
    public sealed class F7_TenderEvaluationRow : Row, IIdRow, INameRow
    {
        ...
        public F7_TenderEvaluationRow() : base(Fields) { }
