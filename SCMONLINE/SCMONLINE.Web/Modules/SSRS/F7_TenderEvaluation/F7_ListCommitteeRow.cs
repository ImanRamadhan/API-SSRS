namespace SCMONLINE.Procurement.Entities
{
    ...
    [DisplayName("F7 List Committee"), InstanceName("F7 List Committee"), TwoLevelCached]
    public sealed class F7_ListCommitteeRow : Row, IIdRow, INameRow
    {
        ...
        public F7_ListCommitteeRow() : base(Fields) { }
