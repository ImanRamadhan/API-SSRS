namespace SCMONLINE.Procurement.Entities
{
    ...
    [DisplayName("F7 Evaluasi Penawaran"), InstanceName("F7 Tender Evaluation"), TwoLevelCached]
    [ReadPermission("Procurement:F7_VendorParticipant:Read")]
    [InsertPermission("Procurement:F7_VendorParticipant:Insert")]
    [UpdatePermission("Procurement:F7_VendorParticipant:Update")]
    [DeletePermission("Procurement:F7_VendorParticipant:Delete")]
    public sealed class F7_VendorParticipantRow : Row, IIdRow, INameRow
    {
        ...
        public F7_VendorParticipantRow() : base(Fields) { }
