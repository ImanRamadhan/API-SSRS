namespace SCMONLINE.Procurement.Entities
{
    ...
    [ReadPermission("Procurement:F5_ProcParticipantItem:Read")]
    [InsertPermission("Procurement:F5_ProcParticipantItem:Insert")]
    [UpdatePermission("Procurement:F5_ProcParticipantItem:Update")]
    [DeletePermission("Procurement:F5_ProcParticipantItem:Delete")]
    public sealed class F5_ProcParticipantItemRow : Row, IIdRow, INameRow
    {
        ...
        public F5_ProcParticipantItemRow() : base(Fields) { }
