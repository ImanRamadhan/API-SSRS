namespace SCMONLINE.Procurement {
    ...
    export class OwnerEstimateReviewImportDialog extends Serenity.PropertyDialog<any, any> {

        private form: OwnerEstimateReviewImportForm;

        public rfqItemsEditor: F10_RfqItemsEditor;

        constructor() {
            super();

            this.form = new OwnerEstimateReviewImportForm(this.idPrefix);
        }
            ...
            return [
                {
                    ...
                    click: () => {
                        ...
                        F10_NegotiationService.OwnerEstimateReviewImport({
