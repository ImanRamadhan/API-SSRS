...
namespace SCMONLINE.Procurement {
    ...
    export class F13_RfqItemsEditor extends Common.GridEditorBase<RfqItemRow> {
        ...
        protected getButtons(): Serenity.ToolButton[] {
            ...
            buttons.push({
                ...
                onClick: () => {
                    ...
                    Q.postToService({ service: F13_RfqItemService.baseUrl + "/ListExcelOwnerEstimateReview", request: gridRows, target: '_blank' });
                }
            });
