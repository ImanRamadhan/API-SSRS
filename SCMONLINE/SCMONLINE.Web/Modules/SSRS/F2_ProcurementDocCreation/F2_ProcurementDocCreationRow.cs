namespace SCMONLINE.Procurement.Entities
{
    ...
    [DisplayName("F2 Procurement Doc Creation"), InstanceName("F2 Procurement Doc Creation"), TwoLevelCached]
    [ReadPermission("Procurement:F2_ProcurementDocCreation:Read")]
    [InsertPermission("Procurement:F2_ProcurementDocCreation:Insert")]
    [UpdatePermission("Procurement:F2_ProcurementDocCreation:Update")]
    [DeletePermission("Procurement:F2_ProcurementDocCreation:Delete")]
    public sealed class F2_ProcurementDocCreationRow : Row, IIdRow, INameRow
    {
        ...
        public F2_ProcurementDocCreationRow() : base(Fields) { }
