namespace SCMONLINE.Procurement.Entities
{
    ...
    [DisplayName("F14 Winner Announcement"), InstanceName("F14 Winner Announcement"), TwoLevelCached]
    [ReadPermission("Procurement:F14_WinnerAnnouncement:Read")]
    [InsertPermission("Procurement:F14_WinnerAnnouncement:Insert")]
    [UpdatePermission("Procurement:F14_WinnerAnnouncement:Update")]
    [DeletePermission("Procurement:F14_WinnerAnnouncement:Delete")]
    public sealed class F14_WinnerAnnouncementRow : Row, IIdRow, INameRow
    {
        ...
        public F14_WinnerAnnouncementRow() : base(Fields) { }
