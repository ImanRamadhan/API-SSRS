namespace SCMONLINE.Procurement.Entities
{
    ...
    [DisplayName("F14 VendorApprovalRow"), InstanceName("F14 VendorApprovalRow"), TwoLevelCached]
    [ReadPermission("Procurement:F14_VendorApprovalRow:Read")]
    [InsertPermission("Procurement:F14_VendorApprovalRow:Insert")]
    [UpdatePermission("Procurement:F14_VendorApprovalRow:Update")]
    [DeletePermission("Procurement:F14_VendorApprovalRow:Delete")]
    public sealed class F14_VendorApprovalRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("NamaVendor"), Size(100), QuickSearch]
        public String NamaVendor { get { return Fields.NamaVendor[this]; } set { Fields.NamaVendor[this] = value; } }
        public partial class RowFields { public StringField NamaVendor; }

        [DisplayName("collectivenumber"), Size(100), QuickSearch]
        ...
        IIdField IIdRow.IdField { get { return Fields.Email; } }

        StringField INameRow.NameField { get { return Fields.NamaVendor; } }

        public static readonly RowFields Fields = new RowFields().Init();

        public F14_VendorApprovalRow() : base(Fields) { }
