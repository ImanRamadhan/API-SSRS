namespace SCMONLINE.Procurement.Entities
{
    ...
    [DisplayName("F13 Proc Participant"), InstanceName("F13 Proc Participant"), TwoLevelCached]
    [ReadPermission("Procurement:F13_ProcParticipant:Read")]
    [InsertPermission("Procurement:F13_ProcParticipant:Insert")]
    [UpdatePermission("Procurement:F13_ProcParticipant:Update")]
    [DeletePermission("Procurement:F13_ProcParticipant:Delete")]
    public sealed class F13_ProcParticipantRow : Row, IIdRow, INameRow
    {
        ...
        public F13_ProcParticipantRow() : base(Fields) { }
