namespace SCMONLINE.Procurement.Entities
{
    ...
    [DisplayName("F17 Purch Order Doc Upload"), InstanceName("F17 Purch Order Doc Upload"), TwoLevelCached]
    [ReadPermission("Procurement:F17_PurchOrderDocUpload:Read")]
    [InsertPermission("Procurement:F17_PurchOrderDocUpload:Insert")]
    [UpdatePermission("Procurement:F17_PurchOrderDocUpload:Update")]
    [DeletePermission("Procurement:F17_PurchOrderDocUpload:Delete")]
    public sealed class F17_PurchOrderDocUploadRow : Row, IIdRow, INameRow
    {
        ...
        public F17_PurchOrderDocUploadRow() : base(Fields) { }
