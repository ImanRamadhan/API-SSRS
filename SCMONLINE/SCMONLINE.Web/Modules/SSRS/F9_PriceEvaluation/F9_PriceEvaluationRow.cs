namespace SCMONLINE.Procurement.Entities
{
    ...
    [DisplayName("F9 Price Evaluation"), InstanceName("F9 Price Evaluation"), TwoLevelCached]
    [ReadPermission("Procurement:F9_PriceEvaluation:Read")]
    [InsertPermission("Procurement:F9_PriceEvaluation:Insert")]
    [UpdatePermission("Procurement:F9_PriceEvaluation:Update")]
    [DeletePermission("Procurement:F9_PriceEvaluation:Delete")]
    public sealed class F9_PriceEvaluationRow : Row, IIdRow, INameRow
    {
        ...
        public F9_PriceEvaluationRow() : base(Fields) { }
