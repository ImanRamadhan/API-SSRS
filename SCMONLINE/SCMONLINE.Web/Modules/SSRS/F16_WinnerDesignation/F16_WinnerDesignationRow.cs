namespace SCMONLINE.Procurement.Entities
{
    ...
    [DisplayName("F16 Winner Designation"), InstanceName("F16 Winner Designation"), TwoLevelCached]
    [ReadPermission("Procurement:F16_WinnerDesignation:Read")]
    [InsertPermission("Procurement:F16_WinnerDesignation:Insert")]
    [UpdatePermission("Procurement:F16_WinnerDesignation:Update")]
    [DeletePermission("Procurement:F16_WinnerDesignation:Delete")]
    public sealed class F16_WinnerDesignationRow : Row, IIdRow, INameRow
    {
        ...
        public F16_WinnerDesignationRow() : base(Fields) { }
