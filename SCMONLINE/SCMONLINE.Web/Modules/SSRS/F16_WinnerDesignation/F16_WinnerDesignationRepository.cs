...
namespace SCMONLINE.Procurement.Repositories
{
    ...
    public class F16_WinnerDesignationRepository
    {
        ...
        private class MyRetrieveHandler : RetrieveRequestHandler<MyRow>
        {
            protected override void OnReturn()
            {
                ...
                if (Row.F16SubmitDate != null || Row.Status == "F16") { }
        ...
        private class MyListHandler : ListRequestHandler<MyRow>
        {
            protected override void ApplyFilters(SqlQuery query)
            {
                ...
                query.Where(new Criteria(fld.F16SubmitDate).IsNotNull() || new Criteria(fld.Status) == "F16");
