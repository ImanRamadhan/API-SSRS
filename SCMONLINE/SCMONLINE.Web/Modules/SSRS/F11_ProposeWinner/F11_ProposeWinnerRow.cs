namespace SCMONLINE.Procurement.Entities
{
    ...
    [DisplayName("F11 Propose Winner"), InstanceName("F11 Propose Winner"), TwoLevelCached]
    [ReadPermission("Procurement:F11_ProposeWinner:Read")]
    [InsertPermission("Procurement:F11_ProposeWinner:Insert")]
    [UpdatePermission("Procurement:F11_ProposeWinner:Update")]
    [DeletePermission("Procurement:F11_ProposeWinner:Delete")]
    public sealed class F11_ProposeWinnerRow : Row, IIdRow, INameRow
    {
        ...
        public F11_ProposeWinnerRow() : base(Fields) { }
