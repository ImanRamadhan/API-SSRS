namespace SCMONLINE.Procurement.Entities
{
    ...
    [DisplayName("F11 Prupose Winner"), InstanceName("F11 Prupose Winner"), TwoLevelCached]
    [ReadPermission("Procurement:F11_AgreementRow:Read")]
    [InsertPermission("Procurement:F11_AgreementRow:Insert")]
    [UpdatePermission("Procurement:F11_AgreementRow:Update")]
    [DeletePermission("Procurement:F11_AgreementRow:Delete")]
    public sealed class F11_AgreementRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Agreement"), Size(100), QuickSearch]
        public String Agreement { get { return Fields.Agreement[this]; } set { Fields.Agreement[this] = value; } }
        public partial class RowFields { public StringField Agreement; }
        ...
        StringField INameRow.NameField { get { return Fields.Agreement; } }

        public static readonly RowFields Fields = new RowFields().Init();

        public F11_AgreementRow() : base(Fields) { }
