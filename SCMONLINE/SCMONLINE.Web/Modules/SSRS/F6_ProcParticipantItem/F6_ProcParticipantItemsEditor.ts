...
namespace SCMONLINE.Procurement {
    ...
    export class F6_ProcParticipantItemsEditor extends Common.GridEditorBase<ProcParticipantItemRow> {
        ...
        protected getButtons(): Serenity.ToolButton[] {
            ...
            buttons.push({
                ...
                onClick: () => {
                    ...
                    Q.postToService({ service: F6_ProcParticipantItemService.baseUrl + "/ListExcelBidPrice", request: gridRows, target: '_blank' });
                }
            });
