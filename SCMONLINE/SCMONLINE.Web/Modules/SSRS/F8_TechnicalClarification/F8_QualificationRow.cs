namespace SCMONLINE.Procurement.Entities
{
    ...
    [DisplayName("F8 Qualification"), InstanceName("F8 Qualification"), TwoLevelCached]
    //[ReadPermission("Procurement:F8_TechnicalClarification:Read")]
    //[InsertPermission("Procurement:F8_TechnicalClarification:Insert")]
    //[UpdatePermission("Procurement:F8_TechnicalClarification:Update")]
    //[DeletePermission("Procurement:F8_TechnicalClarification:Delete")]
    public sealed class F8_QualificationRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Vendorid"), Size(100), QuickSearch]
        ...
        [DisplayName("EvaluationConclusionItemName"), Size(100), QuickSearch]
        ...
        public F8_QualificationRow() : base(Fields) { }
