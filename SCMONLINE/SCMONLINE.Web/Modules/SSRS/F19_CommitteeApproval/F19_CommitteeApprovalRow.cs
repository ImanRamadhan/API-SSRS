namespace SCMONLINE.Procurement.Entities
{
    ...
    [DisplayName("F19 Committee Approval"), InstanceName("F19 Committee Approval"), TwoLevelCached]
    [ReadPermission("Procurement:F19_CommitteeApproval:Read")]
    [InsertPermission("Procurement:F19_CommitteeApproval:Insert")]
    [UpdatePermission("Procurement:F19_CommitteeApproval:Update")]
    [DeletePermission("Procurement:F19_CommitteeApproval:Delete")]
    public sealed class F19_CommitteeApprovalRow : Row, IIdRow, INameRow
    {
        ...
        public F19_CommitteeApprovalRow() : base(Fields) { }
