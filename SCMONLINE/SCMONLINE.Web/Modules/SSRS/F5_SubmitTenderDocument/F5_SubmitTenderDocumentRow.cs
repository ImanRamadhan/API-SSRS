namespace SCMONLINE.Procurement.Entities
{
    ...
    [DisplayName("F5 Submit Tender Document"), InstanceName("F5 Submit Tender Document"), TwoLevelCached]
    [ReadPermission("Procurement:F5_SubmitTenderDocument:Read")]
    [InsertPermission("Procurement:F5_SubmitTenderDocument:Insert")]
    [UpdatePermission("Procurement:F5_SubmitTenderDocument:Update")]
    [DeletePermission("Procurement:F5_SubmitTenderDocument:Delete")]
    public sealed class F5_SubmitTenderDocumentRow : Row, IIdRow, INameRow
    {
        ...
        public F5_SubmitTenderDocumentRow() : base(Fields) { }
