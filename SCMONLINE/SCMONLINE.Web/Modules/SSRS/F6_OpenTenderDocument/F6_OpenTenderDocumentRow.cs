namespace SCMONLINE.Procurement.Entities
{
    ...
    [DisplayName("F6 Open Tender Document"), InstanceName("F6 Open Tender Document"), TwoLevelCached]
    [ReadPermission("Procurement:F6_OpenTenderDocument:Read")]
    [InsertPermission("Procurement:F6_OpenTenderDocument:Insert")]
    [UpdatePermission("Procurement:F6_OpenTenderDocument:Update")]
    [DeletePermission("Procurement:F6_OpenTenderDocument:Delete")]
    public sealed class F6_OpenTenderDocumentRow : Row, IIdRow, INameRow
    {
        ...
        public F6_OpenTenderDocumentRow() : base(Fields) { }
