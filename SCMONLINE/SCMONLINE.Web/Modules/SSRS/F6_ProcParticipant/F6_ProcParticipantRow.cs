namespace SCMONLINE.Procurement.Entities
{
    ...
    [DisplayName("F6 Proc Participant"), InstanceName("F6 Proc Participant"), TwoLevelCached]
    [ReadPermission("Procurement:F6_ProcParticipant:Read")]
    [InsertPermission("Procurement:F6_ProcParticipant:Insert")]
    [UpdatePermission("Procurement:F6_ProcParticipant:Update")]
    [DeletePermission("Procurement:F6_ProcParticipant:Delete")]
    public sealed class F6_ProcParticipantRow : Row, IIdRow, INameRow
    {
        ...
        public F6_ProcParticipantRow() : base(Fields) { }
