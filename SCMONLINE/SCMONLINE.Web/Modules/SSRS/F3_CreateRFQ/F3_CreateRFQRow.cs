namespace SCMONLINE.Procurement.Entities
{
    ...
    [DisplayName("F3 Create Rfq"), InstanceName("F3 Create Rfq"), TwoLevelCached]
    [ReadPermission("Procurement:F3_CreateRFQ:Read")]
    [InsertPermission("Procurement:F3_CreateRFQ:Insert")]
    [UpdatePermission("Procurement:F3_CreateRFQ:Update")]
    [DeletePermission("Procurement:F3_CreateRFQ:Delete")]
    public sealed class F3_CreateRFQRow : Row, IIdRow, INameRow
    {
        ...
        public F3_CreateRFQRow() : base(Fields) { }
