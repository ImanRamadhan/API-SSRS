namespace SCMONLINE.Default.Entities
{
    ...
    [ReadPermission("Default:Procurement:Read")]
    [InsertPermission("Default:Procurement:Insert")]
    [UpdatePermission("Default:Procurement:Update")]
    [DeletePermission("Default:Procurement:Delete")]
    public sealed class ProcurementRow : Row, IIdRow, INameRow
    {
        ...
        [DisplayName("Classification"), Size(60), ForeignKey("[dbo].[ProcurementClassification]", "ClassificationCode"), LeftJoin("jClassification"), TextualField("ClassificationAssociationCode")]
        ...
        [DisplayName("Committee Type"), ForeignKey("[dbo].[CommitteeType]", "CommitteeTypeId"), LeftJoin("jCommitteeType"), TextualField("CommitteeTypeName")]
        ...
        [DisplayName("Technical Explanation")]
        ...
        [DisplayName("Administrative Explanation")]
        ...
        [DisplayName("Evaluation Closing Price Date")]
        ...
        [DisplayName("Proc Reject Tender")]
        public Boolean? ProcRejectTender { get { return Fields.ProcRejectTender[this]; } set { Fields.ProcRejectTender[this] = value; } }
		public partial class RowFields { public BooleanField ProcRejectTender; }

        [DisplayName("Proc Reject Tender Desc")]
