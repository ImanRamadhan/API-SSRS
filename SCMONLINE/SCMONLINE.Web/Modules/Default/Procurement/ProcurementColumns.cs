...
namespace SCMONLINE.Default.Columns
{
    ...
    [ColumnsScript("Default.Procurement")]
    [BasedOnRow(typeof(Entities.ProcurementRow), CheckNames = true)]
    public class ProcurementColumns
    {
        ...
        public String ClassificationAssociationCode { get; set; }
        ...
        public DateTime F19SubmitDate { get; set; }
        public String F19SubmitBy { get; set; }
        public String ProcurementMethodName { get; set; }
        public String District { get; set; }
        public String Csms { get; set; }
        public String MinScore { get; set; }
        public Boolean ProcRejectTender { get; set; }
