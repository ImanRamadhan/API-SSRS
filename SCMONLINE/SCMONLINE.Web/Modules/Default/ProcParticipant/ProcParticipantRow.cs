namespace SCMONLINE.Default.Entities
{
    ...
    [DisplayName("Proc Participant"), InstanceName("Proc Participant"), TwoLevelCached]
    [ReadPermission("Default:ProcParticipant:Read")]
    [InsertPermission("Default:ProcParticipant:Insert")]
    [UpdatePermission("Default:ProcParticipant:Update")]
    [DeletePermission("Default:ProcParticipant:Delete")]
    public sealed class ProcParticipantRow : Row, IIdRow, INameRow
    {
        ...
        public Boolean? Invitation { get { return Fields.Invitation[this]; } set { Fields.Invitation[this] = value; } }
		public partial class RowFields { public BooleanField Invitation; }

        [DisplayName("Quote Desc")]
        ...
        [DisplayName("Procurement Technical Explanation"), Expression("jProcurement.[TechnicalExplanation]"), ReadOnly(true)]
        public String ProcurementTechnicalExplanation { get { return Fields.ProcurementTechnicalExplanation[this]; } set { Fields.ProcurementTechnicalExplanation[this] = value; } }
		public partial class RowFields { public StringField ProcurementTechnicalExplanation; }

        [DisplayName("Procurement Administrative Explanation"), Expression("jProcurement.[AdministrativeExplanation]"), ReadOnly(true)]
        public String ProcurementAdministrativeExplanation { get { return Fields.ProcurementAdministrativeExplanation[this]; } set { Fields.ProcurementAdministrativeExplanation[this] = value; } }
		public partial class RowFields { public StringField ProcurementAdministrativeExplanation; }

        [DisplayName("Procurement Other Explanation"), Expression("jProcurement.[OtherExplanation]"), ReadOnly(true)]
        public String ProcurementOtherExplanation { get { return Fields.ProcurementOtherExplanation[this]; } set { Fields.ProcurementOtherExplanation[this] = value; } }
		public partial class RowFields { public StringField ProcurementOtherExplanation; }
        ...
        [DisplayName("Procurement F19 Submit Date"), Expression("jProcurement.[F19SubmitDate]"), ReadOnly(true)]
        public DateTime? ProcurementF19SubmitDate { get { return Fields.ProcurementF19SubmitDate[this]; } set { Fields.ProcurementF19SubmitDate[this] = value; } }
		public partial class RowFields { public DateTimeField ProcurementF19SubmitDate; }

        [DisplayName("Procurement F19 Submit By"), Expression("jProcurement.[F19SubmitBy]"), ReadOnly(true)]
        public String ProcurementF19SubmitBy { get { return Fields.ProcurementF19SubmitBy[this]; } set { Fields.ProcurementF19SubmitBy[this] = value; } }
		public partial class RowFields { public StringField ProcurementF19SubmitBy; }
        ...
        [DisplayName("Procurement Proc Reject Tender"), Expression("jProcurement.[ProcRejectTender]"), ReadOnly(true)]
        public Boolean? ProcurementProcRejectTender { get { return Fields.ProcurementProcRejectTender[this]; } set { Fields.ProcurementProcRejectTender[this] = value; } }
		public partial class RowFields { public BooleanField ProcurementProcRejectTender; }

        [DisplayName("Procurement Proc Reject Tender Desc"), Expression("jProcurement.[ProcRejectTenderDesc]"), ReadOnly(true)]
        public String ProcurementProcRejectTenderDesc { get { return Fields.ProcurementProcRejectTenderDesc[this]; } set { Fields.ProcurementProcRejectTenderDesc[this] = value; } }
		public partial class RowFields { public StringField ProcurementProcRejectTenderDesc; }
