        ...
        public DirectoryEntry Validate(string username, string password)
        {
            ...
            try
            {
                ...
                var request = new SearchRequest(
                        ...
                        "(&(objectClass=*)(mailNickName=" + username + "))",
                        SearchScope.Subtree,
                        new string[] { "mailNickName", "givenName", "sn", "mail" });
                ...
                var uid = item.Attributes["mailNickName"];
            ...
            {
                throw new Exception(String.Format("PagedSearch SendRequest threw an LdapException:{0}{1}", Environment.NewLine, err.ToString()));
            }
